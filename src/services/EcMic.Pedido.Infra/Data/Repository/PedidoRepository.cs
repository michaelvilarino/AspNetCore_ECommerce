...
namespace EcMic.Pedido.Infra.Data.Repository
{
    public class PedidoRepository : IPedidoRepository
    {
        ...
        public async Task<EcMic.Pedido.Domain.Pedidos.Pedido> ObterPorId(Guid id)
        {
            return await _context.Pedidos.FindAsync(id);
        }

        public async Task<IEnumerable<EcMic.Pedido.Domain.Pedidos.Pedido>> ObterListaPorClienteId(Guid clienteId)
        {
        ...
        public void Adicionar(EcMic.Pedido.Domain.Pedidos.Pedido pedido)
        {
            _context.Pedidos.Add(pedido);
        }

        public void Atualizar(EcMic.Pedido.Domain.Pedidos.Pedido pedido)
        {
