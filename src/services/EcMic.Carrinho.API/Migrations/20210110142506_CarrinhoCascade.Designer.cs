...
namespace EcMic.Carrinho.API.Migrations
{
    ...
    [Migration("20210110142506_CarrinhoCascade")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EcMic.Carrinho.API.Models.CarrinhoCliente", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("EcMic.Carrinho.API.Models.CarrinhoItem", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("EcMic.Carrinho.API.Models.CarrinhoCliente", b =>
                {
                    b.OwnsOne("EcMic.Carrinho.API.Models.Voucher", "Voucher", b1 =>
                        {
            ...
            modelBuilder.Entity("EcMic.Carrinho.API.Models.CarrinhoItem", b =>
                {
                    b.HasOne("EcMic.Carrinho.API.Models.CarrinhoCliente", "CarrinhoCliente")
                        .WithMany("Itens")
